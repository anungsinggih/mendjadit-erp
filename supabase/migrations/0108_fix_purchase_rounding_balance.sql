-- ============================================================
-- 0108_fix_purchase_rounding_balance.sql
-- Round journal allocation to avoid unbalanced entry
-- ============================================================
...
begin
  ...
  v_round_diff := v_total - (v_total_fg + v_total_rm);
  if v_round_diff <> 0 then
    if v_total_fg > 0 then
      v_total_fg := v_total_fg + v_round_diff;
    else
      v_total_rm := v_total_rm + v_round_diff;
    end if;
  end if;
