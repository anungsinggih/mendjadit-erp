-- ============================================================
-- 0100_fix_purchase_draft_dedupe.sql
-- Dedupe purchase draft items before insert to satisfy unique constraint
-- ============================================================
...
begin
  ...
  -- 4. Insert New Items (dedup by item_id+unit_cost+uom_snapshot)
